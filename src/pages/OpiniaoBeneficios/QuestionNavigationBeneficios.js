...
const QuestionNavigationBeneficios = ({ activeQuestion, setActiveQuestion }) => {
  const questions = [
    {
      id: "utilizacao-avaliacao",
      title: "Utilização e Avaliação",
      subtitle: "Como você avalia cada benefício oferecido",
      icon: "clipboard-check"
    },
    {
      id: "concordancia-beneficios",
      title: "Concordância sobre Benefícios",
      subtitle: "Clareza, informação e satisfação geral",
      icon: "hand-thumbs-up"
    }
  ]
    ...
    <>
      ...
      <div className="question-navigation-beneficios">
        <div className="nav-title">
          Perguntas sobre Benefícios da Eldorado
        </div>
...
export default QuestionNavigationBeneficios