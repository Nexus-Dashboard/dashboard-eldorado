...
const TrajetoriaEldorado = () => {
  ...
  const dados2023 = {
    ...
    intencaoSaida: 3,
    distribuicao: [
      { categoria: "Vejo como um lugar para construir uma carreira de longo prazo", percentage: 42 },
      { categoria: "Tenho vontade de crescer e evoluir profissionalmente", percentage: 41 },
      { categoria: "Quero continuar na empresa, mas sem grandes expectativas no momento", percentage: 8 },
      { categoria: "Ainda estou refletindo sobre o meu futuro", percentage: 5 },
      { categoria: "Não me vejo na Eldorado no futuro", percentage: 3 },
      { categoria: "Não sei dizer", percentage: 1 }
    ]
  }
  ...
  const ChartComponent = ({ data, year }) => {
    ...
    return (
      <div className="chart-container">
        {/* Header com categorias resumidas */}
        <div className="chart-header">
          <div className="categories-summary">
            <div className="category-badge alta">
              ...
              <span className="category-value">{data.altaIntencao}%</span>
            </div>
            
            <div className="category-badge analise">
              <span className="category-title">Trajetória em análise</span>
              <span className="category-value">{data.trajetoriaAnalise}%</span>
            </div>
            
            <div className="category-badge saida">
              <span className="category-title">Intenção de saída</span>
              <span className="category-value">{data.intencaoSaida}%</span>
            </div>
          </div>
        </div>

        {/* Gráfico Horizontal */}
        <div style={{ height: "400px", backgroundColor: "#f0f0f0", marginTop: "20px" }}>
          <ResponsiveBar
            data={chartData}
            keys={['percentage']}
            indexBy="categoria"
